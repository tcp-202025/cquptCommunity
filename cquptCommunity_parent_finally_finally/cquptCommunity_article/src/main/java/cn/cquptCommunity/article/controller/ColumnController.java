...
public class ColumnController {
	...
	public Result apply(@RequestBody Column column){
		...
		String userid = claims.getId();//拿到当前用户的userid
		columnService.apply(column,userid);
