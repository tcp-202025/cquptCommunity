package cn.cquptCommunity.recruit.service;
...
import cn.cquptCommunity.recruit.dao.RecruitDao;
...
public class RecruitService {
	...
	/**
	 * 查询推荐职位:传入的是state参数，state代表状态，值为2的时候表示代表推荐
	 */
	public List<Recruit> recommend(){
		return recruitDao.findTop5ByStateOrderByCreatetimeDesc("2");
	}

	/**
	 * 查询最新职位:0表示关闭，！0表示职位是开启的，所以需要传入参数！0，实现查询最新则需要通过在sql语句中排序
	 */
